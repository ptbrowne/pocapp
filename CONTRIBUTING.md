...
- What is the version of the Cozy pocapp?
...
```
$ git clone github.com/lenn/pocapp.git
$ cd pocapp
$ git remote add fork git://github.com/yourusername/pocapp.git
```
...
Go to https://github.com/yourusername/pocapp and select your branch. Click the 'Pull Request' button and fill out the form.
...
The pocapp is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/lenn/pocapp/issues/new
...
[localization]: https://github.com/lenn/pocapp/blob/master/README.md#localization
