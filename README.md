[![Travis build status shield](https://img.shields.io/travis/lenn/pocapp/master.svg)](https://travis-ci.org/lenn/pocapp)
[![NPM release version shield](https://img.shields.io/npm/v/pocapp.svg)](https://www.npmjs.com/package/pocapp)
[![Github Release version shield](https://img.shields.io/github/tag/lenn/pocapp.svg)](https://github.com/lenn/pocapp/releases)
[![NPM Licence shield](https://img.shields.io/npm/l/pocapp.svg)](https://github.com/lenn/pocapp/blob/master/LICENSE)
...
poc application for extended modal
...
Hacking the Cozy pocapp app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/lenn/pocapp.git
$ cd pocapp
$ yarn install
```
...
$ docker run --rm -it -p 8080:8080 -v "$(pwd)/build":/data/cozy-app/pocapp cozy/cozy-app-dev
or
$ yarn stack:docker
```

your app is available at http://pocapp.cozy.tools:8080.
...
If you want to work on pocapp and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for pocapp is [lenn](https://github.com/lenn), send him/her a :beers: to say hello!
...
pocapp is developed by lenn and distributed under the [AGPL v3 license][agpl-3.0].
